-- subquery
-- 1) from 절의 서브 쿼리 * alias 필수! ex) 4번 줄의 s; 
select * 
...
-- 실습문제 3: 현재급여가 50000 이상인 직원의 이름을 출력하세요.
-- 대혁 50001
-- 둘리 50002
...
-- soution1 : where subquery =any(in)
