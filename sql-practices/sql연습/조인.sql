...
-- 예제2 : employees 테이블과 titles 테이블을 join하여 직원의 이름과 직책을 
-- 출력하되 여성 엔지니어만 출력하세요.
...
select a.first_name, b.title
	...
	-- on a.emp_no = b.emp_no    / natural join은 생략
...
select a.name as '이름', ifnull(b.name, '없음') as '부서'
 	from emp a left join dept b on a.dept_no = b.no; -- left join 길동 나옴
...
-- 현재 직책별로 급여의 총합을 구하되 Engineer직책은 제외하세요. 단, 총합이 2,000,000,000이상인 직책만 나타내며
